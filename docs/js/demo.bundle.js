...
/* WEBPACK VAR INJECTION */(function(base) {var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(6), __webpack_require__(8)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else if (typeof exports !== "undefined") {
    factory(require('../src'), require('gi-js-base/src/utils/dom'));
  } else {
    var mod = {
      exports: {}
    };
  ...
  var scroller = new _dom.Scroller({
    offsetY: 20
  });

  base.features.add('accordion', _src2.default, {
    scroller: scroller
  });
...
/* WEBPACK VAR INJECTION */(function(global) {/** handorgel v0.4.1, @license MIT */
...
/* harmony export (immutable) */ __webpack_exports__["$$"] = $$;
/* harmony export (immutable) */ __webpack_exports__["outerHeight"] = outerHeight;
/* harmony export (immutable) */ __webpack_exports__["outerWidth"] = outerWidth;
/* harmony export (immutable) */ __webpack_exports__["computedStyles"] = computedStyles;
/* harmony export (immutable) */ __webpack_exports__["computedStyle"] = computedStyle;
...
/* harmony export (immutable) */ __webpack_exports__["parents"] = parents;
/* harmony export (immutable) */ __webpack_exports__["index"] = index;
/* harmony export (immutable) */ __webpack_exports__["style"] = style;
/* harmony export (immutable) */ __webpack_exports__["scrollY"] = scrollY;
/* harmony export (immutable) */ __webpack_exports__["scrollX"] = scrollX;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_easing_js_easing__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__fn__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__string__ = __webpack_require__(11);
/**
 * DOM module.
...
function outerHeight(element) {
  ...
  height += Object(__WEBPACK_IMPORTED_MODULE_2__string__["a" /* pxToInt */])(style.marginTop) + Object(__WEBPACK_IMPORTED_MODULE_2__string__["a" /* pxToInt */])(style.marginBottom)
  return height
}
...
function outerWidth(element) {
  ...
  width += Object(__WEBPACK_IMPORTED_MODULE_2__string__["a" /* pxToInt */])(style.marginLeft) + Object(__WEBPACK_IMPORTED_MODULE_2__string__["a" /* pxToInt */])(style.marginRight)
  return width
}
 ...
 * @returns {Object} Computed styles
 */
function computedStyles(element, pseudoElement = null) {
  let computedStyle = {},
      styles = {}
 ...
 * @returns {Element[]}
 */
function parents(element, match = null) {
  let parents = []
 ...
 * @returns {Object|{}} Original style attributes which got overwritten.
 */
function style(element, styles, remember = false) {
...
/* harmony export (immutable) */ __webpack_exports__["Sheet"] = Sheet;
...
class Scroller {
  ...
  to(options = {}) {
    ...
    function tick() {
      ...
      let t = __WEBPACK_IMPORTED_MODULE_0_easing_js_easing__[opts.easing](p)
      ...
      if (p < 1) {
        Object(__WEBPACK_IMPORTED_MODULE_1__fn__["a" /* rAF */])(tick)
        rootElement.scrollTop = posY
        rootElement.scrollLeft = posX
      } else {
        rootElement.scrollTop = scrollTargetY !== null ? scrollTargetY : scrollYPos
...
/* harmony export (immutable) */ __webpack_exports__["Scroller"] = Scroller;
 ...
 *   A new function that wraps the `func` function passed in.
 */
function debounce(func, wait = 60, immediate = false) {
  var timeout, args, context, timestamp, result
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = pxToInt;
/* unused harmony export pad */
/* unused harmony export startsWith */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_camel_case__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_camel_case___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_camel_case__);
/**
 * String module.
 * @module base/utils/string
 */
...
/* unused harmony default export */ var _unused_webpack_default_export = ({
  camelCase: __WEBPACK_IMPORTED_MODULE_0_camel_case___default.a,
  pad,
  pxToInt,
  startsWith
});
